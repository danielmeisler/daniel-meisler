...
\f\r"'\`<>=]|("|')|))|$)`, "g");
  ...
  // src/App.ts
  var _handleMenuSwitch, _handlePageSwitch, _handleKeyDown;
  var App = class extends i4 {
    constructor() {
      ...
      __privateAdd(this, _handleKeyDown, this.handleKeyEvents.bind(this));
    }
    get menuItems() {
      return [
        {
        ...
        },
        {
          name: "career",
          label: msg("career"),
          content: [x`<dm-career></dm-career>`, x`<dm-school></dm-school>`]
        },
        {
          name: "skills",
          label: msg("skills"),
  ...
  `;
    ...
    render() {
      return x`
			<button class="back-button" @click="${this.handleClick}" aria-label="${msg("Return to menu")}">
  ...
  // src/components/CareerSection.ts
  var CareerSection = class extends i4 {
    constructor() {
      super(...arguments);
      this.mode = "left";
    }
    static {
      __name(this, "CareerSection");
    }
    static {
      this.styles = i`
    :host {
  ...
  __decorateClass([
    n4()
  ], CareerSection.prototype, "mode", 2);
  customElements.define("dm-career-section", CareerSection);

  // src/components/Content.ts
  var Content = class extends i4 {
    static {
      __name(this, "Content");
    }
    static {
  ...
  `;
    ...
    render() {
      ...
      ${this.isParty ? x`<dm-party></dm-party>` : ""}
    `;
    }
  };
  __decorateClass([
    r5()
  ], Logo.prototype, "isParty", 2);
  ...
  // src/components/Party.ts
  var Party = class extends i4 {
    constructor() {
      super(...arguments);
      this.beams = [];
      this.lights = [];
      this.dancerSwitch = true;
      this.mouseX = 0;
      this.mouseY = 0;
      this.colors = ["#ff7979", "#686de0", "#badc58", "#f6e58d", "#ffbe76", "#e056fd", "#7ed6df", "#dff9fb"];
      this.updateAnimation = /* @__PURE__ */ __name(() => {
        const time = Date.now() / 2750;
        const xLoc = window.innerWidth / 2;
        this.beams.forEach((beam, z2) => {
          ...
          beam.style.boxShadow = `0px 0px 30px 10px ${this.colors[z2]}, 0px 0px 150px 10px ${this.colors[z2]}`;
          beam.style.transform = `rotate(${time % 360 * 180 + z2 * 45}deg)`;
        });
        requestAnimationFrame(this.updateAnimation);
      }, "updateAnimation");
      this.shuffleArray = /* @__PURE__ */ __name((array) => {
        for (let i5 = array.length - 1; i5 > 0; i5--) {
          const j2 = Math.floor(Math.random() * (i5 + 1));
          [array[i5], array[j2]] = [array[j2], array[i5]];
        }
      }, "shuffleArray");
      this.remakeLights = /* @__PURE__ */ __name(() => {
      ...
      this.startParty = /* @__PURE__ */ __name(() => {
        this.createLights();
        this.updateAnimation();
        window.addEventListener("mousemove", (e5) => {
          this.mouseX = e5.clientX;
          this.mouseY = e5.clientY;
          const dancer = this.shadowRoot?.getElementById("disco-ball");
          let transform = "";
  ...
  `;
    ...
    getLightStyle(x2, y3, color) {
      return `
      left: ${x2}px; top: ${y3}px;
      box-shadow:
    ...
    firstUpdated() {
      this.beams = Array.from(
        { length: 8 },
        (_2, i5) => this.shadowRoot?.getElementById(`beam${i5}`)
      );
      setInterval(() => this.shuffleArray(this.colors), 1e3);
    ...
    render() {
      ...
      <div id="container">
        ...
        ${Array.from({ length: 8 }, (_2, i5) => x`<div id="beam${i5}" class="beam"></div>`)}
  ...
  `;
    ...
    render() {
      ...
      <div class="socials-container">
        ...
        <a href="https://github.com/danielmeisler" class="socials-button" target="_blank" rel="noopener noreferrer" aria-label="${msg("GitHub")}">
        ...
        <a href="https://www.linkedin.com/in/daniel-meisler-22361a379" class="socials-button" target="_blank" rel="noopener noreferrer" aria-label="${msg("LinkedIn")}">
        ...
        <a href="https://www.instagram.com/daniel.meisler" class="socials-button" target="_blank" rel="noopener noreferrer" aria-label="${msg("Instagram")}">
        ...
        <a href="mailto:daniel_meisler@web.de" class="socials-button" aria-label="${msg("E-Mail")}">
        ...
        <button @click="${this.handleSettings}" class="socials-button" aria-label="${msg("Settings")}">
  ...
  // src/components/SpeechBubble.ts
  var SpeechBubble = class extends i4 {
    static {
      __name(this, "SpeechBubble");
    }
    static {
      this.styles = i`
    :host {
